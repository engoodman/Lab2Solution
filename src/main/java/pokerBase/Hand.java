...
//ExplodedHands
//Fix Player.java errors
//Table.java and Game.java 
//Fix isFiveOfAKind (not sure this is done correctly)
//JUnit Testing
...
public class Hand { 
	 ...
	 * @return
	 */
	public static boolean isHandFourOfAKind(Hand h, HandScore hs) { //GO OVER THIS CODE
	...
	public static Comparator<Hand> HandRank = new Comparator<Hand>(){
		public int compare (Hand h1, Hand h2){
			int result = 0;
			result = h2.getHs().getHandStrength()-h1.getHs().g.etHandStrength();
			if(result != 0){
				return result;
			}
